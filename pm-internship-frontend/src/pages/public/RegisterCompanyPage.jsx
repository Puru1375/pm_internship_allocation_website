...
export default function RegisterCompanyPage() {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      if (res?.success) {
        setMessage(res.message || 'Check your email for your verification code. Please enter it below.');
        setStep('verify');
      } else {
      ...
      <div className="w-full max-w-3xl bg-white rounded-2xl shadow-lg shadow-blue-100/30 p-6 md:p-10">
        ...
        {step === 'verify' && (
          <form onSubmit={handleVerify} className="space-y-5">
            <div className="text-center text-slate-700 text-sm">Enter the 6-digit code sent to your email to activate your account.</div>
            <div>
